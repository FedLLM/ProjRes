...
data_name = 'E:/Dataset/aclImdb_v1'
raw_data = utility_function.preprocess_IMDB(data_name)
dataset = utility_function.CustomDataset(raw_data)
total_size = len(dataset)
base_size = total_size // client_number
extra = total_size % client_number
data_name = 'E:/Dataset/aclImdb_v1'
test_raw_data = utility_function.preprocess_IMDB(data_name, data_class='test')
...
for batch_size in batch_sizes:
    ...
    # 保存为 JSON 文件
    file_path = f'results/mia_llama_imdb_results_{batch_size}.json'
